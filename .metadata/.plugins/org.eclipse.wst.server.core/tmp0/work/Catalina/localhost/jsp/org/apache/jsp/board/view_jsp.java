 ...
 * Generated at: 2025-09-15 05:52:46 UTC
...
try {
 ...
 if (cuid != null && cuid.equals(login_id)) { 
      ...
      out.write("</td>\r\n");
      out.write("	    <td colspan=\"3\">\r\n");
      out.write("	    	<form action=\"comment_modify.jsp\" method=\"post\" class=\"edit-form\">\r\n");
 ...
 if(login_id != null) { 
      ...
      out.write("<a href=\"modify_check.jsp?idx=");
      out.print( idx );
      out.write("\"><button type=\"button\" class=\"btn-modify\">수정</button></a>\r\n");
      out.write("<a href=\"delete.jsp?idx=");
      out.print( idx );
      out.write("\"><button type=\"button\" class=\"btn-delete\">삭제</button></a>\r\n");
      out.write("<button type=\"button\" onclick=\"history.back()\" class=\"btn-list\">목록</button>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("<style>\r\n");
...
if (conn != null){
   conn.close();
      ...
      out.write("        editRow.style.display = 'table-row'; // <tr>의 기본 display 값은 table-row\r\n");
      out.write("    } else {\r\n");
